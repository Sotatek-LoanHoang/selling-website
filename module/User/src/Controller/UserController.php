...
class UserController extends AbstractActionController
{
  ...
  /**
   * This action displays a page for new user to signup.
   */
  public function signupAction()
  {
    // Create user form
    $form = new UserForm('signup', $this->entityManager);
    ...
    if ($this->getRequest()->isPost()) {
      ...
      if ($form->isValid()) {
        ...
        // Add user.
        $user = $this->userManager->signupUser($data);

        // Redirect to "message" page
        return $this->redirect()->toRoute(
          'users',
          ['action' => 'message', 'id' => 'email-sent']
        );
      }
    }
  ...
  public function activateAction()
  {
    ...
    if ($token === null ||
      !$this->userManager->activateUser($token)) {
      return $this->redirect()->toRoute(
        'users',
