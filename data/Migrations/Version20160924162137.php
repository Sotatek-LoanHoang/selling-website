...
class Version20160924162137 extends AbstractMigration
{
  ...
  public function up(Schema $schema)
  {
    ...
    $table->addColumn('username', 'string', ['notnull' => true, 'length' => 64]);
    $table->addColumn('email', 'string', ['notnull' => true, 'length' => 128]);
    $table->addColumn('full_name', 'string', ['notnull' => false, 'length' => 512]);
    ...
    $table->addColumn('activate_token', 'string', ['notnull' => false, 'length' => 32]);
